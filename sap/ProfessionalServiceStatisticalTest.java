...
public class ProfessionalServiceStatisticalTest extends BaseSapTest {
    ...
    private static final String PROJECT_ID = "S.9609";
    private static final String PROJECT_VALUE = "01";

    @Test(groups = {"JOB4", "UI"})
    @TestParameters(azureId = "401")
    public void createStatiscalProject() throws InterruptedException {
