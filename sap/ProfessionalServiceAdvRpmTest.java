...
public class ProfessionalServiceAdvRpmTest extends BaseSapTest{

    private static final ProjectType PROJECT_TYPE = ProjectType.ADV_RPM;
    ...
    @Test(priority = 701, groups = {"JOB1", "API"})
    @TestParameters(azureId = "701", recording = false)
    public void createAdvisoryRpmProjectTest(ITestContext context) {

        // Location at which API Logs will be saved - /report/evidence/701/<logfile>
    ...
    @Test(priority = 702, groups = {"JOB4", "API"})
    @TestParameters(azureId = "702", recording = false)
    public void getAdvisoryRpmProjectErpIdFromNetSuiteTest(ITestContext context) {

        // Location at which API Logs will be saved - /report/evidence/702/<logfile>
        String azureId = (String) context.getAttribute("azureId");
    ...
    @Test(priority = 703, groups = {"JOB4", "UI"}, dependsOnMethods = {"getAdvisoryRpmProjectErpIdFromNetSuiteTest"})
    @TestParameters(azureId = "703")
    public void verifyAdvisoryRpmProjectDataInSap() {
    ...
    @Test(priority = 704, groups = {"JOB4", "UI"}, dependsOnMethods = {"getAdvisoryRpmProjectErpIdFromNetSuiteTest"})
    @TestParameters(azureId = "704")
    public void verifyAdvisoryRpmProjectPricingConditionDataInSap() {
    ...
    @Test(priority = 705,enabled = false, groups = {"JOB4", "API"}, dependsOnMethods = {"getAdvisoryRpmProjectErpIdFromNetSuiteTest"})
    @TestParameters(azureId = "705", recording = false)
    @Ignore
    public void submitTimeSheetForAdvisoryRpmProjectTest(ITestContext context) {
    ...
    @Test(priority = 705, groups = {"JOB4", "API"}, dependsOnMethods = {"getAdvisoryRpmProjectErpIdFromNetSuiteTest"})
    @TestParameters(azureId = "705", recording = false)
    public void submitCpiTimeSheetForAdvisoryRpmProjectTest(ITestContext context) {
    ...
    @Test(priority = 706, enabled = false, groups = {"JOB4", "UI"}, dependsOnMethods = {"getAdvisoryRpmProjectErpIdFromNetSuiteTest"})
    @TestParameters(azureId = "706")
    public void verifyTimeSheetForAdvisoryRpmProjectTest() {
    }

    @Test(priority = 707, groups = {"JOB4", "API"}, dependsOnMethods = {"getAdvisoryRpmProjectErpIdFromNetSuiteTest"})
    @TestParameters(azureId = "707")
    public void submitExpenseForAdvisoryRpmProjectTest(ITestContext context) {
    ...
    @Test(priority = 708, groups = {"JOB4", "UI"}, dependsOnMethods = {"getAdvisoryRpmProjectErpIdFromNetSuiteTest"})
    @TestParameters(azureId = "708")
    public void createAdvisoryRpmProjectOnAccountBillingFromBtp() {
    ...
    @Test(priority = 709, groups = {"JOB4", "UI"}, dependsOnMethods = {"getAdvisoryRpmProjectErpIdFromNetSuiteTest", "createAdvisoryRpmProjectOnAccountBillingFromBtp"})
    @TestParameters(azureId = "709")
    public void generateAdvisoryRpmProjectOnAccountInvoiceTest() {
    ...
    @Test(priority = 710, enabled = false, groups = {"JOB4", "UI"}, dependsOnMethods = {"getAdvisoryRpmProjectErpIdFromNetSuiteTest"})
    @TestParameters(azureId = "710")
    public void verifyOnAccountInvoiceInBtp() {

    }

    @Test(priority = 711, groups = {"JOB4", "UI"}, dependsOnMethods = {"getAdvisoryRpmProjectErpIdFromNetSuiteTest"})
    @TestParameters(azureId = "711")
    public void createAdvisoryRpmProjectTimeAndExpenseBillingFromSap() {
    ...
    @Test(priority = 712, groups = {"JOB4", "UI"}, dependsOnMethods = {"getAdvisoryRpmProjectErpIdFromNetSuiteTest", "submitCpiTimeSheetForAdvisoryRpmProjectTest", "createAdvisoryRpmProjectTimeAndExpenseBillingFromSap"})
    @TestParameters(azureId = "712")
    public void generateAdvisoryRpmProjectTimeAndExpenseInvoiceTest() {
    ...
    @Test(priority = 713, enabled = false, groups = {"JOB4", "UI"}, dependsOnMethods = {"getAdvisoryRpmProjectErpIdFromNetSuiteTest"})
    @TestParameters(azureId = "713")
